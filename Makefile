...
SOURCES = \
	__init__.py \
	create_relation.py create_relation_dialog.py

PLUGINNAME = create_relation

PY_FILES = \
	__init__.py \
	create_relation.py create_relation_dialog.py

UI_FILES = create_relation_dialog_base.ui
...
QGISDIR=C:\Users\Faustino\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
